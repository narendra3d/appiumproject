...
public class PerformanceDetails
{
	public static void main(String[] args) throws Exception
	{
		...
		try
		{
			...
			wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@class='android.widget.Button'][@instance='6']")));
			driver.findElement(By.xpath("//*[@class='android.widget.Button'][@instance='6']")).click();
			wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@class='android.widget.Button'][@instance='5']")));
			driver.findElement(By.xpath("//*[@class='android.widget.Button'][@instance='5']")).click();
			wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@class='android.widget.Button'][@instance='4']")));
			driver.findElement(By.xpath("//*[@class='android.widget.Button'][@instance='4']")).click();
