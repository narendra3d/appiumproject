...
public class MultiTouchActionSliders2
{
	public static void main(String[] args) throws Exception
	{
		...
		try
		{
			...
			ta1.press(ElementOption.point(e1x1,e1y1)).moveTo(ElementOption.point(e1x2,e1y2)).release();
			TouchAction ta2=new TouchAction(driver);
			ta2.press(ElementOption.point(e2x1,e2y1)).moveTo(ElementOption.point(e2x2,e2y2)).release();
			Thread.sleep(5000);
